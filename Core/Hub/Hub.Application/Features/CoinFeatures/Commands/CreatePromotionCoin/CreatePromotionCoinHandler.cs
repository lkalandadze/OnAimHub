...
public class CreatePromotionCoinHandler : IRequestHandler<CreatePromotionCoin>
{
    ...
    public CreatePromotionCoinHandler(ICoinRepository promotionCoinRepository, IWithdrawOptionRepository withdrawOptionRepository, IPromotionRepository promotionRepository, IUnitOfWork unitOfWork)
    {
