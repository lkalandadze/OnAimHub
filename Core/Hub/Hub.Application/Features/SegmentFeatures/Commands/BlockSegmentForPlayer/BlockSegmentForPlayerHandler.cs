...
public class BlockSegmentForPlayerHandler : IRequestHandler<BlockSegmentForPlayerCommand>
{
    ...
    public BlockSegmentForPlayerHandler(ISegmentRepository segmentRepository, IPlayerRepository playerRepository, IPlayerSegmentActService playerSegmentActService, IUnitOfWork unitOfWork)
    {
