...
public class AssignSegmentToPlayerHandler : IRequestHandler<AssignSegmentToPlayerCommand>
{
    ...
    public AssignSegmentToPlayerHandler(ISegmentRepository segmentRepository, IPlayerRepository playerRepository, IPlayerSegmentActService playerSegmentActService, IUnitOfWork unitOfWork)
    {
