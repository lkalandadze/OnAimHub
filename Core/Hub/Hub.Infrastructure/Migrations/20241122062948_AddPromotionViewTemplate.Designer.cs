...
namespace Hub.Infrastructure.Migrations
{
    ...
    [Migration("20241122062948_AddPromotionViewTemplate")]
    partial class AddPromotionViewTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PromotionCoinWithdrawOption", b =>
                {
                    b.Property<string>("PromotionCoinsId")
                        .HasColumnType("text");

                    b.Property<int>("WithdrawOptionsId")
                        .HasColumnType("integer");

                    b.HasKey("PromotionCoinsId", "WithdrawOptionsId");

                    b.HasIndex("WithdrawOptionsId");

                    b.ToTable("PromotionCoinWithdrawOption");
                });
            ...
            modelBuilder.Entity("PromotionCoinWithdrawOption", b =>
                {
                    ...
                    b.HasOne("Hub.Domain.Entities.WithdrawOption", null)
                        .WithMany()
                        .HasForeignKey("WithdrawOptionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
