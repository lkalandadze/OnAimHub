...
var c = host.Services.CreateScope().ServiceProvider.GetRequiredService<TestWheelConfigDbContext>();
...
static void CreateDatabaseIfNotExists()
{
    ...
    //var optionsBuilder = new DbContextOptionsBuilder<SharedGameConfigDbContext<TestWheelConfiguration>>();
    var optionsBuilder = new DbContextOptionsBuilder<SharedGameConfigDbContext>();
    optionsBuilder.UseNpgsql(connectionString);

    var dbContext = new TestWheelConfigDbContext(optionsBuilder.Options);
