...
{
    Task<ApplicationResult> AssignSegmentToPlayers(string segmentId, IFormFile file);
    Task<ApplicationResult> AssignSegmentToPlayer(string segmentId, int playerId);
    Task<ApplicationResult> BlockSegmentForPlayers(string segmentId, IFormFile file);
    ...
    Task<ApplicationResult> UnAssignPlayersToSegment(string segmentId, IFormFile file);
    ...
    Task<ApplicationResult> UnBlockSegmentForPlayers(string segmentId, IFormFile file);
